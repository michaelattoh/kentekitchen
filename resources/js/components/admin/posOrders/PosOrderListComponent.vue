                    ...
                    <tbody class="db-table-body" v-if="orders.length > 0">
                        <tr class="db-table-body-tr" v-for="order in orders" :key="order">
                            ...
                            <div class="flex justify-start items-center sm:items-start sm:justify-start gap-1.5">
                                ...
                                <!-- Delete button disabled for frontend -->
                                <!--
...
// import SmIconDeleteComponent from "../components/buttons/SmIconDeleteComponent"; // Delete disabled
...
export default {
    ...
    methods: {
        ...
        // Delete functionality disabled for frontend
    /*
    destroy: function (id) {
